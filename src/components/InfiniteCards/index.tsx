...
export const InfiniteCards = ({
  ...
  return (
    <div className=" flex flex-col md:mx-auto w-screen text-center pt-10 text-white">
      <h2 className="text-4xl font-bold poppins-medium text-transparent bg-gradient-to-b from-sky-600/80 via-sky-300 to-sky-400/60 text-center text-edge-outline whitespace-nowrap bg-clip-text mt-7 mb-7">
        CLIENT TESTIMONIAL
      </h2>
